...
function loadStatsPage()
{
	...
	{
		col_count = 1;
		cell_value = table.rows[row_count].cells[col_count].innerHTML;
		awayTeam = cell_value;
		col_count++;
		cell_value = table.rows[row_count].cells[col_count].innerHTML;
		...
		if(home > away){
			wins++;
			table.rows[row_count].cells[col_count].innerHTML="Cu Boulder"
		}
		else{
			losses++;
			table.rows[row_count].cells[col_count].innerHTML=awayTeam;
		}
	}
...
function loadPlayersPage()
{
		...
		for(player_count=0; player_count < players.length; player_count++)
		{
			a = document.createElement("a")
			a.href="#";
			a.onclick=function(player_count){return function(){switchPlayers(player_count);}}(player_count);
			a.innerHTML=players[player_count].name;
...
function switchPlayers(playerNum)
{
	...
	document.getElementById("p_major").alt = players[playerNum].alt;
